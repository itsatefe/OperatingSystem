...
public class MLFQ_algorithm {
    public static double AWTime;
    public static double ATTime;
    ...
    private void calcTurnArroundTime(process p[]) {
        ...
        System.out.println("Average of TurnArround time :" + (double) AvG / p.length);
        ATTime =(double) AvG / p.length;
    }
